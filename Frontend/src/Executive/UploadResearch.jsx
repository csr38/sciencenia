  ...
  const handleUpload = async () => {
    ...
    reader.onload = async (e) => {
      ...
      try {
        ...
        const response = await axios.post(`${import.meta.env.VITE_BACKEND_URL}/research/upload/`, formData, {
          headers: {
  ...
  return (
    <div>
      ...
      <div className={styles.manageUsersContainer}>
        <h2 className={styles.title}>Selecciona un archivo excel para subir Producción Científica</h2>
        ...
        <input type="file" accept=".xls,.xls,.csv" onChange={handleFileChange} />
