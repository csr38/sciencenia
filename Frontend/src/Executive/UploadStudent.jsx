  ...
  const handleUpload = async () => {
    ...
    reader.onload = async (e) => {
      ...
      try {
        ...
        const response = await axios.post(`${import.meta.env.VITE_BACKEND_URL}/users/upload`, formData, {
          headers: {
  ...
  return (
    <div>
      ...
      <div className={styles.manageUsersContainer}>
        <h2 className={styles.title}>Selecciona un archivo excel para subir Estudiantes</h2>
