...
interface CallForFundsHistoryProps {
  navigation: any; 
}

export const CallForFundsHistory: FC<CallForFundsHistoryProps> = ({ navigation }) => {
  return (
    <View style={$card}>
      <View style={$header}>
        <Text style={$title} text="Ver Solicitudes de Recursos" />
      </View>
      <Text style={$description}>
        Revisa el historial de solicitudes de recursos ya aceptadas, rechazadas o pendientes.
      </Text>
      <Button 
        text="Ver Recursos" 
        style={$pinkButton}
