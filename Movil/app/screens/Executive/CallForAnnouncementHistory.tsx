...
interface CallForAnnouncementsHistoryProps {
  navigation: any; 
}

export const CallForAnnouncementsHistory: FC<CallForAnnouncementsHistoryProps> = ({ navigation }) => {
  return (
    <View style={$card}>
      <View style={$header}>
        <Text style={$title} text="Ver todos los Anuncios" />
      </View>
      <Text style={$description}>
        Revisa el historial de anuncios y sus postulaciones ya aceptadas, rechazadas o pendientes.
      </Text>
      <Button 
        text="Ver Anuncios" 
        style={$pinkButton}
        ...
        onPress={() => {
          navigation.navigate('ShowAllAnnouncements')
        }}
      />
    </View>
  );
