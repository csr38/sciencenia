...
interface CallForFundsAviableMoneyManagementProps {
  navigation: any; 
}

export const CallForFundsAviableMoneyManagement: FC<CallForFundsAviableMoneyManagementProps> = ({ navigation }) => {
  return (
    <View style={$card}>
      <View style={$header}>
        <Text style={$title} text="Manejo de Fondos Disponibles"/>
      </View>
      <Text style={$description}>
        Crea o edita los fondos disponibles para asignar en la solicitudes de fondos
      </Text>
      <Button 
        text="Ver Fondos" 
        style={$pinkButton}
        ...
        onPress={() => {
          navigation.navigate('ShowFundsManagment')
        }}
      />
    </View>
  );
