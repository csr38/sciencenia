...
interface CallForNotificationCreationProps {
  navigation: any; 
}

export const CallForNotificationCreation: FC<CallForNotificationCreationProps> = ({ navigation }) => {
  return (
    <View style={$card}>
      <View style={$header}>
        <Text style={$title} text="Crear anuncios"/>
      </View>
      <Text style={$description}>
        Crea anuncios para avisar a los estudiantes sobre eventos importantes, actualizaciones o recordatorios.
      </Text>
      <Button 
        text="Crear" 
        style={$pinkButton}
