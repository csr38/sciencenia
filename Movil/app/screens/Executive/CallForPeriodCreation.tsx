...
interface CallForPeriodCreationProps {
  navigation: any; 
}

export const CallForPeriodCreation: FC<CallForPeriodCreationProps> = ({ navigation }) => {
  return (
    <View style={$card}>
      <View style={$header}>
        <Text style={$title} text="Crear periodo de postulación a becas"/>
      </View>
      <Text style={$description}>
        Crea un periodo de postulaciones a becas para que los estudiantes puedan postular.
      </Text>
      <Button 
        text="Crear" 
        style={$pinkButton}
